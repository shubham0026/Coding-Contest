...
public class DeleteSongInPlaylistCommand implements ICommand{

    private final IPlaylistService playlistService;
    
    public DeleteSongInPlaylistCommand(IPlaylistService playlistService) {
    ...
    public void execute(List<String> tokens) {
        ...
        Playlist playlist = playlistService.deleteSongInPlaylistCommand(userId,playListId,songIds);
